defmodule KafkaEx.Protocol.Offset.Test do
  ...
  test "parse_response correctly parses a valid response with an offset" do
    ...
    expected_response = [%KafkaEx.Protocol.Offset.Response{partition_offsets: [%{error_code: :no_error, offset: '\n', partition: 0}], topic: "bar"}]
  ...
  test "parse_response correctly parses a valid response with multiple offsets" do
    ...
    expected_response = [%KafkaEx.Protocol.Offset.Response{partition_offsets: [%{error_code: :no_error, offset: [10, 20], partition: 0}], topic: "bar"}]
  ...
  test "parse_response correctly parses a valid response with multiple topics" do
    ...
    expected_response = [
      %KafkaEx.Protocol.Offset.Response{partition_offsets: [%{error_code: :no_error, offset: [10], partition: 0}], topic: "bar"},
      %KafkaEx.Protocol.Offset.Response{partition_offsets: [%{error_code: :no_error, offset: [20], partition: 0}], topic: "baz"}
    ]
