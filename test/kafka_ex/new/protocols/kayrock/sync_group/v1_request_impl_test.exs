defmodule KafkaEx.New.Protocols.Kayrock.SyncGroup.V1RequestImplTest do
  use ExUnit.Case, async: true

  alias KafkaEx.New.Protocols.Kayrock.SyncGroup
  alias Kayrock.SyncGroup.V1
  ...
  describe "build_request/2 for V1" do
    ...
    test "preserves existing correlation_id and client_id if present" do
      request = %V1.Request{correlation_id: 42, client_id: "my-client"}
