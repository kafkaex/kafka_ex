defmodule KafkaEx.Support.Compression do
  @moduledoc """
  ...
  def decompress(@gzip_attribute, data), do: :zlib.gunzip(data)
  ...
  def snappy_decompress_chunk(<<valsize::32-unsigned, value::size(valsize)-binary, rest::binary>>, so_far) do
