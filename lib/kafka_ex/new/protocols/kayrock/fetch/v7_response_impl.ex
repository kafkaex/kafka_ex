defimpl KafkaEx.New.Protocols.Kayrock.Fetch.Response, for: Kayrock.Fetch.V7.Response do
  ...
  def parse_response(response) do
    ResponseHelpers.parse_response(response, fn response, partition_resp ->
      ...
      # V7 same fields as V5/V6 (session_id/epoch handled at protocol level)
      [
