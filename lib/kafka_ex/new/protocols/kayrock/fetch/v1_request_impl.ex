defimpl KafkaEx.New.Protocols.Kayrock.Fetch.Request, for: Kayrock.Fetch.V1.Request do
  ...
  def build_request(request, opts) do
    ...
    topics = RequestHelpers.build_topics(fields, Keyword.put(opts, :api_version, 1))
