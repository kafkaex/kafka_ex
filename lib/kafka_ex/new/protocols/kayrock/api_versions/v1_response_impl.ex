defimpl KafkaEx.New.Protocols.Kayrock.ApiVersions.Response, for: Kayrock.ApiVersions.V1.Response do
  @moduledoc """
  ...
  def parse_response(%{error_code: 0, api_versions: api_versions, throttle_time_ms: throttle_time_ms}) do
