defmodule KafkaEx.Auth.SASL.Codec do
  ...
  @callback parse_handshake_response(data :: binary(), expected_corr :: integer(), mechanism :: binary(), version :: integer()) :: 
    :ok | error()
  
  @callback authenticate_request(auth_bytes :: binary() | nil, corr :: integer(), version :: integer(), client_id :: binary()) :: 
    binary()
