defmodule KafkaEx.Consumer.ConsumerGroup.PartitionAssignment do
  @moduledoc """
  Contains typespecs and reference algorithms for assigning partitions

  `round_robin/2` is used by `KafkaEx.Consumer.ConsumerGroup` by default and should
  ...
  Example:
      iex> KafkaEx.Consumer.ConsumerGroup.PartitionAssignment(["m1", "m2"], [{"t1", 0}, {"t2, 1"}, {"t3", 2}])
