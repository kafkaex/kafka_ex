defmodule KafkaEx.Protocol.OffsetFetch do
  ...
  def parse_response(<< _correlation_id :: 32, topics_size :: 32, topics_data :: binary >>) do
  ...
  defp parse_partitions(partitions_size, << partition :: 32, offset :: 64, metadata_size :: 16, metadata :: size(metadata_size)-binary, error_code :: 16, rest :: binary >>, partitions) do
