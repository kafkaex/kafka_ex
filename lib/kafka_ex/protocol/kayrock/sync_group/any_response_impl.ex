defimpl KafkaEx.Protocol.Kayrock.SyncGroup.Response, for: Any do
  @moduledoc """
  Fallback implementation of SyncGroup Response protocol for unknown future versions.
  ...
  - Otherwise: V0 path (nil throttle_time_ms)
  """
