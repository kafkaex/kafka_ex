defimpl KafkaEx.Protocol.Kayrock.Fetch.Response, for: Kayrock.Fetch.V8.Response do
  @moduledoc """
  Implementation for Fetch V8 Response.

  V8 has the same response schema as V7:
  ...
  No response-side changes from V7.
