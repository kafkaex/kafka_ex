defimpl KafkaEx.Protocol.Kayrock.DeleteTopics.Response, for: Any do
  @moduledoc """
  Fallback implementation of DeleteTopics Response protocol for unknown future versions.
  ...
  - Has `throttle_time_ms` key: V1+ path (includes throttle_time_ms)
  - Otherwise: V0 path (no throttle_time_ms)
  """
