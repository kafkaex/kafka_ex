defmodule Kafka.Protocol do
  def create_metadata_request(connection) do
    << 3 :: 16, 0 :: 16, connection.correlation_id :: 32, String.length(connection.client_id) :: 16 >> <>
      connection.client_id <> << 0 :: 32 >>
  end

  def parse_metadata_response(connection, metadata) do
